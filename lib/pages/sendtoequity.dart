...
class SendEquity extends StatefulWidget {
  @override
  _SendEquityState createState() => _SendEquityState();
}

class _SendEquityState extends State<SendEquity> {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      theme: ThemeData(
        primaryColor: Colors.black, // Adjust the shade of cayenne color
      ...
      home: Scaffold(
        appBar: AppBar(
          title: Text(
            'Send to another Equity bank account',
          ...
          child: Column(
            ...
            children: [
              ...
              if (selectedAccount != null)
                Text('Available balance 16,035.49 KES',
              ...
              DropdownButtonFormField<String>(
                ...
                items: <String>['123456789023', '342156789023']
                    .map((String value) {
                  return DropdownMenuItem<String>(
                    value: value,
                    child: Text(value, style: TextStyle(color: Colors.white)),
